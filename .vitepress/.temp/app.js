...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"Darion Docs","description":"Technical documentation and architectural references.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":null,"nav":[{"text":"Overview","link":"/"},{"text":"Guides","link":"/docs/getting-started"},{"text":"API Reference","link":"/docs/api-specifications"}],"sidebar":[{"text":"Fundamentals","collapsed":false,"items":[{"text":"Introduction","link":"/docs/introduction"},{"text":"Architecture","link":"/docs/architecture"}]},{"text":"Core Modules","collapsed":false,"items":[{"text":"Getting Started","link":"/docs/getting-started"},{"text":"Authentication","link":"/docs/authentication"},{"text":"API Specifications","link":"/docs/api-specifications"}]},{"text":"Programming","collapsed":false,"items":[{"text":"Darion Programming Language","link":"/docs/darion-programming-language"}]}],"search":{"provider":"local","options":{"detailedView":true,"translations":{"button":{"buttonText":"Search documentation","buttonAriaLabel":"Search documentation"},"modal":{"displayDetails":"Display detailed list","resetButtonTitle":"Reset search","backButtonTitle":"Close search","noResultsText":"No results for","footer":{"selectText":"to select","selectKeyAriaLabel":"enter","navigateText":"to navigate","navigateUpKeyAriaLabel":"up arrow","navigateDownKeyAriaLabel":"down arrow","closeText":"to close","closeKeyAriaLabel":"escape"}}}}},"socialLinks":[{"icon":"github","link":"https://github.com/darion-technologies/darion-docs"}],"outline":{"level":[2,3],"label":"On this page"},"footer":{"message":"Darion Developer Documentation. Built for reliable engineering decisions, implementation clarity, and long-term platform ownership.","copyright":"Darion Technologies © 2026. All rights reserved."}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CZhQA9Lc.js"));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Layout2), _attrs, {
        "doc-before": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (showDocTools.value) {
              _push2(`<div class="darion-doc-tools"${_scopeId}><nav class="darion-breadcrumbs" aria-label="Breadcrumb"${_scopeId}><!--[-->`);
              ssrRenderList(breadcrumbs.value, (crumb, index) => {
                _push2(`<!--[-->`);
                if (crumb.link && index < breadcrumbs.value.length - 1) {
                  _push2(`<a${ssrRenderAttr("href", crumb.link)}${_scopeId}>${ssrInterpolate(crumb.text)}</a>`);
                } else {
                  _push2(`<span${_scopeId}>${ssrInterpolate(crumb.text)}</span>`);
                }
                if (index < breadcrumbs.value.length - 1) {
                  _push2(`<span class="darion-breadcrumb-separator" aria-hidden="true"${_scopeId}>/</span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--]-->`);
              ...
              if (outlineItems.value.length) {
                _push2(`<button class="darion-outline-toggle" type="button"${ssrRenderAttr("aria-expanded", isOutlineOpen.value)} aria-controls="darion-outline-drawer"${_scopeId}><span aria-hidden="true"${_scopeId}></span><span class="darion-sr-only"${_scopeId}>Open page outline</span></button>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            if (outlineItems.value.length) {
              _push2(`<div class="darion-outline-scrim"${ssrRenderAttr("data-open", isOutlineOpen.value)}${_scopeId}></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (outlineItems.value.length) {
              _push2(`<aside id="darion-outline-drawer" class="darion-outline-drawer"${ssrRenderAttr("data-open", isOutlineOpen.value)} aria-label="Page outline"${_scopeId}><div class="darion-outline-header"${_scopeId}><strong${_scopeId}>On this page</strong><button type="button"${_scopeId}>Close</button></div><nav${_scopeId}><!--[-->`);
              ssrRenderList(outlineItems.value, (header) => {
                _push2(`<a${ssrRenderAttr("href", header.link)}${ssrRenderAttr("data-level", header.level)}${_scopeId}>${ssrInterpolate(header.title)}</a>`);
              });
              _push2(`<!--]--></nav></aside>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              showDocTools.value ? (openBlock(), createBlock("div", {
                key: 0,
                ...
                createVNode("nav", {
                  ...
                  (openBlock(true), createBlock(Fragment, null, renderList(breadcrumbs.value, (crumb, index) => {
                    return openBlock(), createBlock(Fragment, {
                      key: `${crumb.text}-${index}`
                    }, [
                      crumb.link && index < breadcrumbs.value.length - 1 ? (openBlock(), createBlock("a", {
                        key: 0,
                        href: crumb.link
                      }, toDisplayString(crumb.text), 9, ["href"])) : (openBlock(), createBlock("span", { key: 1 }, toDisplayString(crumb.text), 1)),
                      index < breadcrumbs.value.length - 1 ? (openBlock(), createBlock("span", {
                        key: 2,
                ...
                outlineItems.value.length ? (openBlock(), createBlock("button", {
                  key: 0,
                  class: "darion-outline-toggle",
                  type: "button",
                  "aria-expanded": isOutlineOpen.value,
                  "aria-controls": "darion-outline-drawer",
                  onClick: ($event) => isOutlineOpen.value = true
                }, [
                  createVNode("span", { "aria-hidden": "true" }),
                  createVNode("span", { class: "darion-sr-only" }, "Open page outline")
                ], 8, ["aria-expanded", "onClick"])) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              outlineItems.value.length ? (openBlock(), createBlock("div", {
                key: 1,
                class: "darion-outline-scrim",
                "data-open": isOutlineOpen.value,
                onClick: ($event) => isOutlineOpen.value = false
              }, null, 8, ["data-open", "onClick"])) : createCommentVNode("", true),
              outlineItems.value.length ? (openBlock(), createBlock("aside", {
                key: 2,
                ...
                createVNode("div", { class: "darion-outline-header" }, [
                  createVNode("strong", null, "On this page"),
                  createVNode("button", {
                    type: "button",
                    onClick: ($event) => isOutlineOpen.value = false
                  }, "Close", 8, ["onClick"])
                ...
                createVNode("nav", null, [
                  (openBlock(true), createBlock(Fragment, null, renderList(outlineItems.value, (header) => {
                    return openBlock(), createBlock("a", {
                      key: header.link,
                      href: header.link,
                      "data-level": header.level,
                      onClick: ($event) => isOutlineOpen.value = false
                    }, toDisplayString(header.title), 9, ["href", "data-level", "onClick"]);
                  }), 128))
                ])
              ], 8, ["data-open"])) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
